...
public class add_dangerous_manag extends AppCompatActivity implements View.OnClickListener {
   ...
   Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dangerous_manag);
    ...
    public void onClick(View view) {
        ...
        if (location.equalsIgnoreCase("")) {
            ...
            String url = "http://" + hu + ":5000/android_ps_add_dangoures_spot";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    ...
                                    Toast.makeText(add_dangerous_manag.this, "Added Successfully", Toast.LENGTH_SHORT).show();
