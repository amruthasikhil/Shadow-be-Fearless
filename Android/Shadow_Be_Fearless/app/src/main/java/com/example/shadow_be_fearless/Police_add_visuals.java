...
public class Police_add_visuals extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_police_add_visuals);
        ed1 = (EditText) findViewById(R.id.editText33);
        btn = (Button) findViewById(R.id.button28);
        iii = (ImageView) findViewById(R.id.imageView6);
    ...
    public void onClick(View v) {
        ...
        if (v == btn) {
            ...
            String url = "http://" + hu + ":5000/poladdvisuals";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    ...
                                    Toast.makeText(Police_add_visuals.this, "Added Successfully", Toast.LENGTH_SHORT).show();
