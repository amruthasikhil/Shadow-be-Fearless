...
public class user_view_emerg extends AppCompatActivity {
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_emerg);
        l1=(ListView)findViewById(R.id.list0);
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        final String maclis=sh.getString("mac_list","");
        String uid=sh.getString("uid","");
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/us_emergency_help";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                emergency_id=new String[js.length()];
...
//                                rating=new String[js1.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    emergency_id[i]=u.getString("Emergency_id");
                                    date[i]=u.getString("Date");
                                    lattitude[i]=u.getString("Latitude");
...
//                                }
                                ...
                                l1.setAdapter(new Custom_user_view_emerg(getApplicationContext(),emergency_id,date,lattitude,longitude,location));
