...
public class user_safe extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li=(ListView)findViewById(R.id.list6);
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/us_safe_point_managment";
...
//
                                ...
                                li.setAdapter(new Custom_user_view_safe(getApplicationContext(),location,latitude,longitude));
