...
public class user_chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li=(ListView)findViewById(R.id.listview345);
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/us_chat_users";
...
//
                                ...
                                li.setAdapter(new Custom_user_chat(getApplicationContext(),image,name,phonenumber,ulid));
