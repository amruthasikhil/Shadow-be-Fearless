...
public class Custom_user_chat extends BaseAdapter {
    private final Context context;
    String[] image,name,phonenumber,ulid;

    public Custom_user_chat(Context applicationContext, String[] image, String[] name, String[] phonenumber,String[] ulid) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.custom_user_chat,null);
        ...
        Button bb1 = (Button) gridView.findViewById(R.id.button16);
        bb1.setTag(ulid[i]);
        bb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ed.putString("tooid", v.getTag().toString());
                ed.commit();

                Intent ii=new Intent(context.getApplicationContext(),Test.class);
