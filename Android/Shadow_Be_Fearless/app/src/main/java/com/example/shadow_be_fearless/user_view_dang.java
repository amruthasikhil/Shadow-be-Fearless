...
public class user_view_dang extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_dang);
        li=(ListView)findViewById(R.id.list00);

        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/us_view_dangerous";
...
//
                                ...
                                li.setAdapter(new Custom_user_view_dang(getApplicationContext(),location,latitude,longitude));
